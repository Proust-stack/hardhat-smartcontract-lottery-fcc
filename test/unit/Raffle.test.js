...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", () => {
          ...
          describe("constructor", () => {
              it("Initialize the raffle carrectly", async () => {
          ...
          describe("performUpkeep()", () => {
              ...
              it("Updates the raffle state, emits and event, and calls thr vrf coordinator", async () => {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
                  const trxResponse = await raffle.performUpkeep("0x")
          ...
          describe("fulfillRandomWords()", () => {
              ...
              it("Picks a winner, resets the lottery and sends money", async () => {
                  ...
                  await new Promise(async (resolve, reject) => {
                      ...
                      const trx = await raffle.performUpkeep([])
